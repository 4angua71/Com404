...
class Gui(Tk):
    ...
    def __init__(self):
        super().__init__()
        self.default_image = PhotoImage (file="U:/Documents/default.gif")
    ...
    def __add_email_label(self):
        ...
        self.email_label.configure( padx = 10,
                                    pady=10,
                                    text="Email:")
    ...
    def __add_default_image_label(self):
        self.default_image_label = Label(self.email_frame)
        self.default_image_label.pack(side=LEFT)
